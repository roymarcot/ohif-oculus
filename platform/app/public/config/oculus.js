...
window.config = {
  ...
  showStudyList: true,
  // Muestra el nombre del paciente en el encabezado siempre expandido (no colapsable)
  ...
  defaultDataSourceName: 'OculusPACS',
  ...
  dataSources: [
    {
      ...
      sourceName: 'OculusPACS',
      configuration: {
        friendlyName: 'Oculus PACS DICOMWeb',
        name: 'OculusPACS',
